...
export function ProductSettingModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/40">
      <div className="bg-white rounded-[3px] shadow-2xl w-full max-w-[min(96vw,800px)] flex flex-col h-[85vh] overflow-hidden animate-in fade-in zoom-in duration-200">
