...
export function PosBilling() {
  ...
  const calculateItemPrice = (product, currentQty, currentPaymentMode, wholesaleStatus) => {
    ...
    if (false && currentPaymentMode === 'Credit') {
  ...
  return (
    <div className="bg-[#f4f6f9] h-[calc(100vh-45px)] flex flex-col relative overflow-hidden print:h-auto print:overflow-visible print:block">
      <div className="bg-white m-3 mt-0 shadow-sm border border-gray-200 flex-1 flex flex-col md:flex-row overflow-hidden print:hidden">
