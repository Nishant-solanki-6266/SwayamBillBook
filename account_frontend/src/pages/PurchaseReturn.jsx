...
export function PurchaseReturn() {
  ...
  const totalPaid = filteredData.reduce((acc, curr) => acc + (curr.paidAmount !== undefined ? curr.paidAmount : (curr.status === 'PAID' ? curr.totalAmount : 0)), 0);
  const totalBal = filteredData.reduce((acc, curr) => acc + (curr.balance !== undefined ? curr.balance : Math.max(0, (curr.totalAmount || 0) - (curr.paidAmount || 0))), 0);
